...
class DepthBufferData : public BufferData {
public:
	DepthBufferData(xn::DepthMetaData *);
...
typedef TypedOpenNIReader<xn::DepthGenerator, xn::DepthMetaData, DepthBufferData , XN_NODE_TYPE_DEPTH> DepthReader;
